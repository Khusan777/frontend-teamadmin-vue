      ...
      <div v-else>
        ...
        <at-table :head="messagesTableHead" :elements="outBotData">
          <template #element="{ element, index }">
            ...
            >
              <at-badge color="green" rounded>Предупредил</at-badge>
            </at-table-item>
            <at-table-item
              :to="{
                name: 'colleagues.detail',
...
<script>
  ...
  import { getSelfReasonCasesMessages } from '~/services/core/outbotMessages';

  export default {
    name: 'OutBotSelfReasonCases',
    components: {
      AtBadge,
      AtPagination,
      AtTable,
    ...
    setup() {
      ...
      const colleagueSelfReasonCasesMessage = () => {
      ...
      colleagueSelfReasonCasesMessage();
      ...
      watch(
        ...
        debounce(() => {
          ...
          colleagueSelfReasonCasesMessage(query.value);
        }, 500),
        { immediate: true }
      );
