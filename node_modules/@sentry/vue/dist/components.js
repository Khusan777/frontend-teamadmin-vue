...
exports.formatComponentName = function (vm, includeFile) {
    if (!vm) {
...
exports.generateComponentTrace = function (vm) {
    var _a, _b;
    if (((_a = vm) === null || _a === void 0 ? void 0 : _a._isVue) && ((_b = vm) === null || _b === void 0 ? void 0 : _b.$parent)) {
        ...
        var formattedTree = tree
            ...
            return "" + ((i === 0 ? '---> ' : repeat(' ', 5 + i * 2)) +
                (Array.isArray(vm)
                    ? exports.formatComponentName(vm[0]) + "... (" + vm[1] + " recursive calls)"
                    : exports.formatComponentName(vm)));
        })
            .join('\n');
        return "\n\nfound in\n\n" + formattedTree;
    }
    return "\n\n(found in " + exports.formatComponentName(vm) + ")";
};
